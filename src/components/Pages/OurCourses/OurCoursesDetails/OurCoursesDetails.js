          ...
          <Grid item xs={12} sm={6} md={12} lg={8}>
            ...
            <Box sx={{ margin: "40px 0" }}>
              ...
              >
                ...
                innovative ways to buy and fly. Charter an entire jet, or offer
                the seats you don’t need through our app. Either way, there’s no
                longer a need for full or even fractional jet ownership – or
                rigid, non-refundable jet cards.
              </Typography>
            </Box>
              ...
              <Box className="opportunities_text">
                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  <Typography variant="h6">
                    ...
                    at one of Quadra’s beautiful resorts
                  </Typography>
                </Box>
                <Box>
                  <Typography>
            ...
            <Box className="review">
              ...
              <Box sx={{ py: 4 }}>
                ...
                <button>
                  Comment Now
                  <span className="arrow_right" style={{ paddingLeft: "5px" }}>
                    <i className="fas fa-arrow-right"></i>
                  </span>
                </button>
              </Box>
              ...
              <Box
                ...
                spacing={{ xs: 2, md: 3 }}
              >
                <Box className="user_review" item xs={12} sm={6} md={12} lg={2}>
                  <Box>
                    <img
                ...
                <Box item xs={12} sm={6} md={12} lg={6}>
                  <Box className="review_main">
                    <Box sx={{ display: "flex" }} className="review_main_text">
                    ...
                    <Box className="review_texts">
                      <Typography>
                        ...
                        for charters – and the unique ability to buy individual
                        seats. Search the world with ease.
                      </Typography>
                    </Box>
                  </Box>
                </Box>
          ...
          <Grid item xs={12} sm={6} md={12} lg={4}>
            ...
            >
              <Box className="main_form">
                <Typography
                  variant="h6"
                  sx={{ marginLeft: "-168px", paddingTop: "15px" }}
                >
                  Book This Tour
                </Typography>
                <Input
