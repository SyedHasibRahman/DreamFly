...
export const fetchCourses = createAsyncThunk(
  "course/fetchCourses",
  async () => {
    const response = await fetch("https://agile-lowlands-71900.herokuapp.com/course").then((res) =>
      res.json()
    );
    return response;
  }
...
export const postCourses = createAsyncThunk(
  "course/postCourses",
  async (data) => {
    const response = await fetch("https://agile-lowlands-71900.herokuapp.com/course", {
      method: "post",
      headers: {
...
export const deleteCourses = createAsyncThunk(
  ...
  async (id) => {
    const response = await fetch(
      `https://agile-lowlands-71900.herokuapp.com/course/deleteCourse/${id}`,
      {
        method: "delete",
      }
    ).then((res) => res.json());
...
export const updateCourses = createAsyncThunk(
  ...
  async (data, id) => {
    const response = await fetch(`https://agile-lowlands-71900.herokuapp.com/course/${id}`, {
      method: "PUT",
